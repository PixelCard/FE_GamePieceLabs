import type { ByGameNameCategory } from "@/features/collections/by-game-name/types/by-game-name";
...
export const otherCategories = [
  ...
  },
  {
    ...
    imageSrc:
      "https://laserox.net/cdn/shop/collections/MH40S2_StillLife-GuitarStore_2016_1_jpg.webp?v=1720074065&width=800",
  ...
  },
  {
    title: "Accessories",
    imageSrc:
      "https://laserox.net/cdn/shop/collections/18e602cb90c377249006230b7456ff3f.jpg?v=1720074486&width=800",
    imageAlt: "Laser-cut wooden tabletop gaming accessories",
    href: "accessories",
    isArrow: false,
  },
] as const satisfies readonly ByGameNameCategory[];
