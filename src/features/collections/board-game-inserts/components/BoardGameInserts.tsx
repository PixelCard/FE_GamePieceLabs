      ...
      <Wrapper>
        <div className="grid w-full grid-cols-2 items-start gap-x-2 gap-y-1 py-3 sm:flex sm:gap-0">
          <FilterMobileGroup>
            ...
            <Filter presentation="mobile-content" items={[{ id: "accessories", label: "Accessories", count: 1 }, { id: "divider", label: "Divider", count: 4 }, { id: "insert", label: "Insert", count: 276 }]} title="Product" variant="type" />
